      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 md:py-0">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-7xl font-semibold font-sans text-charcoal leading-tight mb-8">
              <span className="font-light ">Faça seu</span>
              <span className="relative inline-block">
                Plano de Negócios
                <span className="absolute bottom-1 left-0 w-full h-7 bg-imperial/35 -z-10 rounded-lg transform -rotate-1"></span>
              </span>
              <br />
              <span className="font-light">em minutos.</span>
            </h1>
            <p className="text-xl text-gray-500 mb-10 leading-relaxed max-w-xl font-light">
              Preencha os dados essenciais da sua startup e deixe nossa nosso
              construtor estruturar o plano de negócios perfeito para você.
            </p>
            ...
            <div className="flex flex-wrap gap-6 items-center">
              <Link to="/criar">
                <Button
                  variant="primary"
                  className="text-lg px-10 py-4 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all"
                >
